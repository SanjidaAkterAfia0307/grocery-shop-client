        ...
        <div style={{ backgroundImage: `url(${subs})`, backgroundRepeat: "no-repeat", height: "80vh", backgroundPosition: "center", backgroundSize: "cover" }}>
            <div className='text-white backdrop-brightness-50 flex flex-col justify-center items-center h-full w-full'>
                <div className='w-4/5 flex flex-col gap-4 '>
                    ...
                    <p className='w-4/5'>Lorem ipsum suscipit quam delectus, sint commodi eos quo voluptatibus illum iusto soluta harum necessitatibus quae, consequuntur adipisci provident! Sint, recusandae.</p>
                    <div className='flex'>
                        <input type="email" name="email" id="" className=' lg:w-[750px] rounded-s-md focus:outline outline-offset-1 text-black outline-primary border-none py-4 px-2' placeholder='email@gmail.com'/>
